...
*  Also add your `FQDN` in  line no. 102, 103, 118, and 120 of [info.py](https://github.com/crazydeveloper3/new-advance-auto-filter-bot/blob/main/info.py) so that streaming feature will work properly.
### Optional Variables
